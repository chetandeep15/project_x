...
import pickle
def predict():
	predict_file='Resources/csv/apple_predict.csv'
	f=open('nn_model_apple','rb')
	net=pickle.load(f)
	print "model loaded"
	...
	#            [net.activate(x)  for x in X_val ], linewidth = 2,
	...
	# pylab.grid()
	# pylab.legend()
	# pylab.savefig('static/apple_predictions_scaled.jpeg')
